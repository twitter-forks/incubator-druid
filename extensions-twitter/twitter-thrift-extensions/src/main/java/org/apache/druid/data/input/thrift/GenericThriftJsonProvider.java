...
/**
 * JsonProvider for JsonPath + Thrift.
 */
public class GenericThriftJsonProvider implements JsonProvider
{
  @Override
  ...
  public int length(final Object o)
  {
    if (o instanceof List) {
      return ((List) o).size();
    } else if (o instanceof ThriftGenericRow) {
      return ((ThriftGenericRow) o).length();
    } else {
      return 0;
    }
  }
  ...
  public Collection<String> getPropertyKeys(final Object o)
  {
    if (o == null) {
      ...
      return ((ThriftGenericRow) o).getFieldIds();
    } else {
      throw new UnsupportedOperationException("Unused");
    }
  }
  ...
  public Object getMapValue(final Object o, final String s)
  {
    if (o == null) {
      ...
      return ((ThriftGenericRow) o).getFieldValueForThriftId(s);
    } else if (o instanceof Map) {
  ...
  {
    return o == null || o instanceof Map || o instanceof ThriftGenericRow;
  }
