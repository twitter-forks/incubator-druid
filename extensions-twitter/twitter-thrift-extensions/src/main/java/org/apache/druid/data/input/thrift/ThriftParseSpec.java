...
public class ThriftParseSpec extends NestedDataParseSpec<JSONPathSpec>
{
  @JsonCreator
  public ThriftParseSpec(
  ...
  {
    return new ThriftParseSpec(spec, getDimensionsSpec(), getFlattenSpec());
  }

  @Override
  public ParseSpec withDimensionsSpec(DimensionsSpec spec)
  {
    return new ThriftParseSpec(getTimestampSpec(), spec, getFlattenSpec());
  }
}
